          ...
          <View style={styles.drawer}>
            ...
            <View style={styles.menuContainer}>
              ...
              >
                ...
                <Text style={styles.menuItemText}>Portfolio & Watchlist</Text>
              </TouchableOpacity>
              ...
              >
                <MaterialIcons name="newspaper" size={24} color="#ff9500" />
                <Text style={styles.menuItemText}>News & Alerts</Text>
              </TouchableOpacity>
