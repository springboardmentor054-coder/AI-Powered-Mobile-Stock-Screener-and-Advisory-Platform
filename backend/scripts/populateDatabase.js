  ...
  for (let i = 0; i < allStocks.length; i++) {
    ...
    try {
      ...
      await stockDataService.upsertFundamentals({
        ...
        quickRatio: fundamentals.quick_ratio,
        interestCoverage: fundamentals.interest_coverage,
        debtToEquityRatio: fundamentals.debt_to_equity_ratio,
      ...
      await stockDataService.upsertShareholding({
        ...
        institutionalHoldingPercentage: shareholding.institutional_holding_percentage,
        publicHoldingPercentage: shareholding.public_holding_percentage,
        foreignInstitutionalHolding: shareholding.foreign_institutional_holding,
        domesticInstitutionalHolding: shareholding.domestic_institutional_holding,
        mutualFundHolding: shareholding.mutual_fund_holding,
        retailHolding: shareholding.retail_holding,
        promoterPledgePercentage: shareholding.promoter_pledge_percentage
      });
